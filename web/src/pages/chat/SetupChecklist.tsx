        ...
        <div
          className={classNames(
            ...
            isCompact
              ...
              : isDark
                ? "rounded-2xl border-slate-700/50 bg-slate-900/40 p-4 text-left"
                : "rounded-2xl border-gray-200 bg-white/70 p-4 text-left",
          )}
        >
          <div
            className={classNames(
        ...
        >
          ...
          <button
            ...
            className={classNames(
              ...
              isCompact
                ? "rounded-xl px-3 py-1.5 min-h-[36px] flex items-center text-[11px]"
